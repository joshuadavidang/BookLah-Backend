...
@app.route("/api/v1/findBySeat/<string:concert_id>/<string:category>/<string:seat_number>")
...
@app.route("/api/v1/createTracking/<string:concert_id>/<string:category>", methods=["POST"])
